...
const DynamicRtc = dynamic(
  import("@components/RtcClient/basic-live-rtc-client"),
  { ssr: false }
);
            ...
            <AccordionDetails className={styles["accordion-details-container"]}>
              ...
              >
                <Button
                  ...
                  variant="contained"
                  color="primary"
                  className={isJoined ? styles.forbidden : ""}
                  onClick={handleJoin}
                >
                  JOIN
                </Button>
                ...
                <Button
                  ...
                  variant="contained"
                  color="primary"
                  className={isPublished ? styles.forbidden : ""}
              ...
              >
                <RadioGroup
                  ...
                  name="gender"
                  value={userRole}
                  className={classes["role-switch-container"]}
                  onChange={changeRole}
                >
                  ...
                  <div className={classes["role-select"]}>
                    <FormControlLabel
                      ...
                      control={<BlueRadio />}
                      label="Anchor"
                      className={classes["role-anchor"]}
                    />
                    <FormControlLabel
                      value="audience"
                      control={<BlueRadio />}
                      label="Audience"
                      className={classes["role-audience"]}
                    />
                  </div>
                </RadioGroup>
              </FormControl>
